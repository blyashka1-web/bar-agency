    ...
    <main>
      ...
      <section className="hero">
        <div className="container">
          ...
          <a href="/cases" className="btn-primary" onClick={handleCaseClick}>
            {isLoading ? 'Загрузка...' : 'Наши проекты'}
          </a>
        </div>
      </section>
      ...
      <section className="main-cases">
        <div className="container">
          ...
          <div className="main-cases-grid">
            <a href="/cases/yandex-food" className="main-case-card" onClick={handleCaseClick}>
