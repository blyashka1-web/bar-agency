...
const casesData = {
  'yandex-food': {
    ...
    emoji: '🍔',
    description: 'Вирусный ролик с 2+ млн просмотров',
    full: 'Мы создали вирусный ролик для сервиса доставки Яндекс Еда. Задача — показать, как быстро и вкусно можно получить заказ, используя юмор и неожиданный поворот.',
    stats: ['2+ млн просмотров', '7 дней до вирала', '35% рост продаж'],
  ...
  'beauty-story': {
    ...
    full: 'Разработали SMM‑стратегию, создали вирусные форматы, настроили таргетинг. Бренд вышел на новый уровень.',
  ...
  'moscow-coffee': {
    ...
    full: 'Запустили вирусный челлендж, привлекли блогеров, создали серию коротких видео. Результат — взрывной рост.',
  ...
  'urban-sneakers': {
    ...
    full: 'Создали бренд с нуля: стратегия, айдентика, запуск в Instagram. Без рекламы — 5000 заявок.',
  ...
  'luxe-jewelry': {
    ...
    full: 'Контент‑стратегия с фокусом на эстетику, премиум‑видео и коллаборации. Охват вырос в 3 раза.',
  ...
  'wine-people': {
    ...
    full: 'Контент с сомелье, прямые эфиры, дегустации. Продажи выросли на 200%.',
  ...
  'appvision': {
    ...
    full: 'Интеграции с блогерами, обзоры в TikTok и Instagram. Приложение собрало 50 000 установок.',
